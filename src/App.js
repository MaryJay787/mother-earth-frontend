...
import NewHerb from './containers/new-herb';
import NewRemedy from './containers/new-remedy';
    ...
    return(
      <div>
        <Switch>
          ...
          <Route exact path='/new_herb' render={() => (<NewHerb />)}/>
          <Route exact path='/new_remedy' render={() => (<NewRemedy />)} />
        </Switch>
      </div>
    )
  }
